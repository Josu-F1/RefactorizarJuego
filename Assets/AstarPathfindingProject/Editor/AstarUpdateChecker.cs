...
namespace Pathfinding {
	...
	public static class AstarUpdateChecker {
		...
		static bool CheckForUpdates () {
			...
			// DESHABILITADO: Verificaciones de actualizaciones deshabilitadas
			// No verificar actualizaciones para evitar conexiones HTTP inseguras
			return false; // Siempre retornar false para deshabilitar el loop
		}
		...
		static void DownloadVersionInfo () {
			...
			// DESHABILITADO: Evitar conexiones HTTP inseguras
			// Las verificaciones de actualizaciones están deshabilitadas para evitar errores de conexión insegura
			Debug.Log("A* Pathfinding Project: Verificación de actualizaciones deshabilitada para evitar conexiones inseguras.");
			
#if UNITY_2018_1_OR_NEWER && false // Deshabilitado
			updateCheckDownload = UnityWebRequest.Get(query);
			updateCheckDownload.SendWebRequest();
#elif false // Deshabilitado
